    ...
    >
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-18 lg:h-20">
          ...
          {/* Desktop Navigation */}
          <div className="hidden lg:flex items-center gap-1 bg-white/[0.04] rounded-full px-2 py-1.5 border border-white/[0.06]">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            >
              <span className="inline-flex items-center gap-1.5 justify-center rounded-md bg-black px-4 py-1.5 text-sm font-semibold text-white">
                Login
          ...
          <button
            ...
            className="lg:hidden p-2 text-white hover:text-white/80 transition-colors rounded-lg hover:bg-white/5"
          >
          ...
          >
            <div className="container mx-auto px-4 py-4 flex flex-col gap-1">
              ...
              <div className="mt-4 pt-4 border-t border-white/10 flex flex-col gap-3">
                ...
                >
                  <span className="flex items-center gap-1.5 justify-center w-full rounded-md bg-black px-5 py-2.5 text-sm font-semibold text-white">
                    Login
                    <ArrowRight className="w-4 h-4" />
                  </span>
                </a>
