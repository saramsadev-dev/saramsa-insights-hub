    ...
    <footer className="relative border-t border-border/50">
      ...
      <div className="bg-card/20">
        <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-20">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="col-span-2 md:col-span-3 lg:col-span-4">
              ...
              <div className="flex items-center gap-3">
                <a href="#" className="w-9 h-9 rounded-lg bg-secondary/60 border border-border/50 flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/40 hover:bg-primary/10 transition-all duration-300">
          ...
          <div className="mt-14 pt-8 border-t border-border/40 flex flex-col md:flex-row justify-between items-center gap-4">
